suite('animation-node', function () {
    ...
    test('calculating transformed time', function () {
        ...
        assert.equal(calculateTransformedTime(4, 1000, 200, {
            easing: function (x) {
                return x;
            }, direction: 'normal'
        }), 200);
        ...
        assert.closeTo(calculateTransformedTime(4, 1000, 200, {
            easing: function (x) {
                return x * x;
            }, direction: 'reverse'
        }), 640, 0.0001);
        assert.closeTo(calculateTransformedTime(4, 1000, 600, {
            easing: function (x) {
                return x * x;
            }, direction: 'alternate'
        }), 360, 0.0001);
        assert.closeTo(calculateTransformedTime(3, 1000, 600, {
            easing: function (x) {
                return x * x;
            }, direction: 'alternate'
        }), 160, 0.0001);
    ...
    test('Animation Node', function () {
        ...
        var timing2 = normalizeTimingInput({
            duration: 1000,
            iterations: 4,
            iterationStart: 0.5,
            easing: 'ease',
