...
window.WebComponents = window.WebComponents || {}, function (e) {
...
}(WebComponents), "undefined" == typeof WeakMap && !function () {
    ...
    var h, v = new WeakMap;
    if (/Trident/.test(navigator.userAgent))h = setTimeout; else if (window.setImmediate)h = window.setImmediate; else {
        var g = [], b = String(Math.random());
        ...
        enqueue: function (e) {
            ...
            switch (e.stopImmediatePropagation(), e.type) {
                ...
                case"DOMNodeInserted":
                    var s, d, r = e.relatedNode, f = e.target;
                    "DOMNodeInserted" === e.type ? (s = [f], d = []) : (s = [], d = [f]);
                    var m = f.previousSibling, p = f.nextSibling, o = c("childList", r);
                    o.addedNodes = s, o.removedNodes = d, o.previousSibling = m, o.nextSibling = p, i(r, function (e) {
    ...
    function r(e, t) {
        if (n(t))e && e(); else {
            var o = function () {
                ("complete" === t.readyState || t.readyState === g) && (t.removeEventListener(b, o), r(e, t))
            };
    ...
    function i(e, t) {
        ...
        var i = t.querySelectorAll("link[rel=import]"), s = 0, d = i.length;
        if (d)for (var c, u = 0; d > u && (c = i[u]); u++)a(c) ? r.call(c, {target: c}) : (c.addEventListener("load", r), c.addEventListener("error", r)); else n()
    }
    ...
    var u = "import", l = Boolean(u in document.createElement("link")), f = Boolean(window.ShadowDOMPolyfill), m = function (e) {
        return f ? ShadowDOMPolyfill.wrapIfNeeded(e) : e
    }, p = m(document), h = {
        get: function () {
    ...
    Object.defineProperty(document, "_currentScript", h), Object.defineProperty(p, "_currentScript", h);
    var v = /Trident/.test(navigator.userAgent), g = v ? "complete" : "interactive", b = "readystatechange";
    l && (new MutationObserver(function (e) {
        ...
        HTMLImports.ready = !0, HTMLImports.readyTime = (new Date).getTime(), p.dispatchEvent(new CustomEvent("HTMLImportsLoaded", {bubbles: !0}))
    ...
    var a = e.path, s = e.rootDocument, d = e.flags, c = e.isIE, u = e.IMPORT_LINK_TYPE, l = "link[rel=" + u + "]", f = {
        documentSelectors: l,
    ...
    e.parser = f, e.IMPORT_SELECTOR = l
}), HTMLImports.addModule(function (e) {
    function t(e) {
        return n(e, i)
    }
    ...
    var o = e.flags, i = e.IMPORT_LINK_TYPE, a = e.IMPORT_SELECTOR, s = e.rootDocument, d = e.Loader, c = e.Observer, u = e.parser, l = {
        documents: {},
        ...
        loaded: function (e, n, i, a, s) {
            if (o.load && console.log("loaded", e, n), n.__resource = i, n.__error = a, t(n)) {
                ...
                void 0 === d && (d = a ? null : r(i, s || e), d && (d.__importLink = n, this.bootDocument(d)), this.documents[e] = d), n.import = d
            }
            u.parseNext()
        },
    ...
    }, f = new d(l.loaded.bind(l), l.loadedAll.bind(l));
    if (l.observer = new c, !document.baseURI) {
        var m = {
            get: function () {
        ...
        Object.defineProperty(document, "baseURI", m), Object.defineProperty(s, "baseURI", m)
    }
    e.importer = l, e.importLoader = f
}), HTMLImports.addModule(function (e) {
    ...
    function i(e, t) {
        if (e = wrap(e), !(a.indexOf(e) >= 0)) {
            a.push(e);
            for (var n, r = e.querySelectorAll("link[rel=" + s + "]"), o = 0, d = r.length; d > o && (n = r[o]); o++)n.import && i(n.import, t);
            t(e)
        }
    }
    ...
    function g(e) {
        e = wrap(e), w.dom && console.group("upgradeDocument: ", e.baseURI.split("/").pop()), t(e), v(e), w.dom && console.groupEnd()
    }
    ...
    var w = e.flags, _ = e.forSubtree, E = e.forDocumentTree, y = !window.MutationObserver || window.MutationObserver === window.JsMutationObserver;
    e.hasPolyfillMutations = y;
    var M = !1, L = [], N = Array.prototype.forEach.call.bind(Array.prototype.forEach), T = Element.prototype.createShadowRoot;
    Element.prototype.createShadowRoot = function () {
        var e = T.call(this);
        return CustomElements.watchShadow(this), e
    }, e.watchShadow = m, e.upgradeDocumentTree = b, e.upgradeSubtree = r, e.upgradeAll = t, e.attachedNode = o, e.takeRecords = h
}), CustomElements.addModule(function (e) {
    function t(t) {
    ...
    function t(t, r) {
        ...
        return d.prototype || (d.prototype = Object.create(HTMLElement.prototype)), d.__name = t.toLowerCase(), d.lifecycle = d.lifecycle || {}, d.ancestry = i(d.extends), a(d), s(d), n(d.prototype), u(d.__name, d), d.ctor = l(d), d.ctor.prototype = d.prototype, d.prototype.constructor = d.ctor, e.ready && v(document), d.ctor
    }
    ...
    function m(e, t) {
        ...
        var r;
        return t ? (r = m(e), r.setAttribute("is", t), r) : (r = L(e), e.indexOf("-") >= 0 && w(r, HTMLElement), r)
    }
    ...
    var h, v = e.upgradeDocumentTree, g = e.upgrade, b = e.upgradeWithDefinition, w = e.implementPrototype, _ = e.useNative, E = ["annotation-xml", "color-profile", "font-face", "font-face-src", "font-face-uri", "font-face-format", "font-face-name", "missing-glyph"], y = {}, M = "http://www.w3.org/1999/xhtml", L = document.createElement.bind(document), N = document.createElementNS.bind(document), T = Node.prototype.cloneNode;
    h = Object.__proto__ || _ ? function (e, t) {
        ...
        return !1
    }, document.registerElement = t, document.createElement = m, document.createElementNS = f, Node.prototype.cloneNode = p, e.registry = y, e.instanceof = h, e.reservedTagList = E, e.getRegisteredDefinition = c, document.register = document.registerElement
}), function (e) {
    function t() {
