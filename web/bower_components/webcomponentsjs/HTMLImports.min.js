...
"undefined" == typeof WeakMap && !function () {
    ...
    function n() {
        ...
        e.forEach(function (e) {
            var r = e.takeRecords();
            i(e), r.length && (e.callback_(r, e), t = !0)
        }), t && n()
    }
    ...
    function l(e) {
        return y ? y : (y = d(M), y.oldValue = e, y)
    }
    ...
    var f, v = new WeakMap;
    if (/Trident/.test(navigator.userAgent))f = setTimeout; else if (window.setImmediate)f = window.setImmediate; else {
    ...
    a.prototype = {
        observe: function (e, t) {
            ...
            i || (i = new p(this, e, t), n.push(i), this.nodes_.push(e)), i.addListeners()
        }, disconnect: function () {
        ...
        enqueue: function (e) {
            ...
            switch (e.stopImmediatePropagation(), e.type) {
                case"DOMAttrModified":
                    var t = e.attrName, r = e.relatedNode.namespaceURI, n = e.target, i = new c("attributes", n);
                    i.attributeName = t, i.attributeNamespace = r;
                    var a = e.attrChange === MutationEvent.ADDITION ? null : e.prevValue;
                    o(n, function (e) {
                        return !e.attributes || e.attributeFilter && e.attributeFilter.length && -1 === e.attributeFilter.indexOf(t) && -1 === e.attributeFilter.indexOf(r) ? void 0 : e.attributeOldValue ? l(a) : i
                    });
                    break;
                case"DOMCharacterDataModified":
                    var n = e.target, i = c("characterData", n), a = e.prevValue;
                    o(n, function (e) {
                ...
                case"DOMNodeInserted":
                    var s, d, n = e.relatedNode, h = e.target;
                    "DOMNodeInserted" === e.type ? (s = [h], d = []) : (s = [], d = [h]);
                    var m = h.previousSibling, p = h.nextSibling, i = c("childList", n);
                    i.addedNodes = s, i.removedNodes = d, i.previousSibling = m, i.nextSibling = p, o(n, function (e) {
    ...
    function n(e, t) {
        if (r(t))e && e(); else {
            var i = function () {
                ("complete" === t.readyState || t.readyState === b) && (t.removeEventListener(g, i), n(e, t))
            };
    ...
    function o(e, t) {
        ...
        var o = t.querySelectorAll("link[rel=import]"), s = 0, d = o.length;
        if (d)for (var c, l = 0; d > l && (c = o[l]); l++)a(c) ? n.call(c, {target: c}) : (c.addEventListener("load", n), c.addEventListener("error", n)); else r()
    }
    ...
    function c(e) {
        var t = e.import;
        t ? i({target: e}) : (e.addEventListener("load", i), e.addEventListener("error", i))
    }

    var l = "import", u = Boolean(l in document.createElement("link")), h = Boolean(window.ShadowDOMPolyfill), m = function (e) {
    ...
    var v = /Trident/.test(navigator.userAgent), b = v ? "complete" : "interactive", g = "readystatechange";
    ...
    var t = /(url\()([^)]*)(\))/g, r = /(@import[\s]+(?!url\())([^;]*)(;)/g, n = {
        resolveUrlsInStyle: function (e) {
            var t = e.ownerDocument, r = t.createElement("a");
            return e.textContent = this.resolveUrlsInCssText(e.textContent, r), e
        }, resolveUrlsInCssText: function (e, n) {
            var i = this.replaceUrls(e, n, t);
            return i = this.replaceUrls(i, n, r)
        }, replaceUrls: function (e, t, r) {
            return e.replace(r, function (e, r, n, i) {
                var o = n.replace(/["']/g, "");
                return t.href = o, o = t.href, r + "'" + o + "'" + i
            })
        }
    };
    e.path = n
    ...
    xhr = {
        async: !0, ok: function (e) {
            ...
            return (e.flags.debug || e.flags.bust) && (t += "?" + Math.random()), i.open("GET", t, xhr.async), i.addEventListener("readystatechange", function () {
                if (4 === i.readyState) {
                    var e = i.getResponseHeader("Location"), t = null;
                    if (e)var t = "/" === e.substr(0, 1) ? location.origin + e : e;
                    r.call(n, !xhr.ok(i) && i, i.response || i.responseText, t)
                }
            }), i.send(), i
    ...
    n.prototype = {
        addNodes: function (e) {
            ...
            if (r.load && console.log("fetch", e, n), e.match(/^data:/)) {
                ...
                var s = function (t, r, i) {
                    this.receive(e, n, t, r, i)
                }.bind(this);
                t.load(e, s)
            }
        }, receive: function (e, t, r, n, i) {
            this.cache[e] = n;
            for (var o, a = this.pending[e], s = 0, d = a.length; d > s && (o = a[s]); s++)this.onload(e, o, n, r, i), this.tail();
            this.pending[e] = null
        }, tail: function () {
    ...
    var a = e.path, s = e.rootDocument, d = e.flags, c = e.isIE, l = e.IMPORT_LINK_TYPE, u = "link[rel=" + l + "]", h = {
        documentSelectors: u,
        ...
        parseStyle: function (e) {
            var t = e;
            e = o(e), e.__importElement = t, this.parseGeneric(e)
        },
        ...
        addElementToDocument: function (e) {
            for (var t = this.rootImportForElement(e.__importElement || e), r = t.__insertedElements = t.__insertedElements || 0, n = t.nextElementSibling, i = 0; r > i; i++)n = n && n.nextElementSibling;
        ...
        trackElement: function (e, t) {
            ...
            if (e.addEventListener("load", n), e.addEventListener("error", n), c && "style" === e.localName) {
                var i = !1;
                if (-1 == e.textContent.indexOf("@import"))i = !0; else if (e.sheet) {
                    i = !0;
                    for (var o, a = e.sheet.cssRules, s = a ? a.length : 0, d = 0; s > d && (o = a[d]); d++)o.type === CSSRule.IMPORT_RULE && (i = i && Boolean(o.styleSheet))
                }
                i && e.dispatchEvent(new CustomEvent("load", {bubbles: !1}))
            }
        },
        parseScript: function (t) {
            var n = document.createElement("script");
            n.__importElement = t, n.src = t.src ? t.src : r(t), e.currentScript = t, this.trackElement(n, function () {
        ...
        nextToParseInDoc: function (e, r) {
            if (e && this._mayParse.indexOf(e) < 0) {
                ...
                for (var n, i = e.querySelectorAll(this.parseSelectorsForNode(e)), o = 0, a = i.length; a > o && (n = i[o]); o++)if (!this.isParsed(n))return this.hasResource(n) ? t(n) ? this.nextToParseInDoc(n.import, n) : n : void 0
            }
            return r
        },
    ...
    function n(e, t) {
        ...
        n.setAttribute("href", t), r.baseURI || (r.baseURI = t);
        var i = r.createElement("meta");
        return i.setAttribute("charset", "utf-8"), r.head.appendChild(i), r.head.appendChild(n), r.body.innerHTML = e, window.HTMLTemplateElement && HTMLTemplateElement.bootstrap && HTMLTemplateElement.bootstrap(r), r
    }

    var i = e.flags, o = e.IMPORT_LINK_TYPE, a = e.IMPORT_SELECTOR, s = e.rootDocument, d = e.Loader, c = e.Observer, l = e.parser, u = {
        documents: {},
        ...
        loaded: function (e, r, o, a, s) {
            if (i.load && console.log("loaded", e, r), r.__resource = o, r.__error = a, t(r)) {
                var d = this.documents[e];
                void 0 === d && (d = a ? null : n(o, s || e), d && (d.__importLink = r, this.bootDocument(d)), this.documents[e] = d), r.import = d
            }
            l.parseNext()
        },
    ...
    }, h = new d(u.loaded.bind(u), u.loadedAll.bind(u));
    if (u.observer = new c, !document.baseURI) {
        var m = {
            get: function () {
    ...
    e.importer = u, e.importLoader = h
}), HTMLImports.addModule(function (e) {
    var t = e.parser, r = e.importer, n = {
        added: function (e) {
            for (var n, i, o, a = 0, s = e.length; s > a && (o = e[a]); a++)n || (n = o.ownerDocument, i = t.isParsed(n)), loading = this.shouldLoadNode(o), loading && r.loadNode(o), this.shouldParseNode(o) && i && t.parseDynamic(o, loading)
        }, shouldLoadNode: function (e) {
            return 1 === e.nodeType && i.call(e, r.loadSelectorsForNode(e))
    ...
    function t() {
        HTMLImports.importer.bootDocument(r)
    }
    ...
    if (initializeModules = e.initializeModules, !e.useNative) {
        "function" != typeof window.CustomEvent && (window.CustomEvent = function (e, t) {
            ...
            return r.initEvent(e, t.bubbles === !1 ? !1 : !0, t.cancelable === !1 ? !1 : !0, t.detail), r
        }), initializeModules();
