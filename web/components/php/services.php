    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 wow bounceInLeft">
                ...
                <p>We provide restaurants customers' suggestions to help the restaurant take customers' suggestions
                    seriously.
                </p>
            </div>
            <div class="col-md-6 col-sm-6 wow bounceInUp">
                ...
                <p>Our application informs customers of the menus, subsequently improving customer satisfaction and
                    increse customer base for the restaurants.
                </p
            </div>
