...
"undefined" == typeof WeakMap && !function () {
        ...
        for (var o = k(t), i = 0; i < o.length; i++) {
            ...
            if ("polymerBlackList_" !== a && !(a in n || t.polymerBlackList_ && t.polymerBlackList_[a])) {
                ...
                if (r && "function" == typeof u.value)n[a] = h(a); else {
                    var p = l(a);
                    s = p ? e.getEventHandlerGetter(a) : d(a), (u.writable || u.set || V) && (c = p ? e.getEventHandlerSetter(a) : f(a)), I(n, a, {
                        get: s,
                        set: c,
    ...
    function h(t, n) {
        ...
        return nt.set(t, o), w(t, o, a, i) && m(t, o, a, i) && g(t, o, a, i), J.set(t, rt), Z.delete(t, null), K.delete(t), t.defaultPrevented
    }
    ...
    var W, A = e.forwardMethodsToWrapper, I = e.getTreeScope, k = e.mixin, F = e.registerWrapper, B = e.setWrapper, U = e.unsafeUnwrap, q = e.unwrap, V = e.wrap, G = e.wrappers, X = (new WeakMap, new WeakMap), z = new WeakMap, K = new WeakMap, Y = new WeakMap, Z = new WeakMap, $ = new WeakMap, J = new WeakMap, Q = new WeakMap, et = new WeakMap, tt = new WeakMap, nt = new WeakMap, rt = 0, ot = 1, it = 2, at = 3;
    b.prototype = {
        equals: function (e) {
    ...
    var M = e.wrappers.EventTarget, T = e.wrappers.NodeList, O = e.TreeScope, j = e.assert, L = e.defineWrapGetter, N = e.enqueueMutation, _ = e.getTreeScope, C = e.isWrapper, D = e.mixin, H = e.registerTransientObservers, x = e.registerWrapper, R = e.setTreeScope, P = e.unsafeUnwrap, W = e.unwrap, A = e.unwrapIfNeeded, I = e.wrap, k = e.wrapIfNeeded, F = e.wrappers, B = !1, U = document.importNode, q = window.Node.prototype.cloneNode, V = window.Node, G = window.DocumentFragment, X = (V.prototype.appendChild, V.prototype.compareDocumentPosition), z = V.prototype.insertBefore, K = V.prototype.removeChild, Y = V.prototype.replaceChild, Z = /Trident/.test(navigator.userAgent), $ = Z ? function (e, t) {
        try {
            K.call(e, t)
        } catch (n) {
    ...
    S.prototype = Object.create(M.prototype), D(S.prototype, {
        appendChild: function (e) {
            ...
            if (this.invalidateShadowRenderer()) {
                ...
                l && $(l, i), c === e && (this.firstChild_ = a), u === e && (this.lastChild_ = s), s && (s.nextSibling_ = a), a && (a.previousSibling_ = s), e.previousSibling_ = e.nextSibling_ = e.parentNode_ = void 0
            } else m(this), $(P(this), i);
    ...
    "use strict";
    function t(t, n, r, o) {
        for (var i = null, a = null, s = 0, c = t.length; c > s; s++)i = v(t[s]), !o && (a = m(i).root) && a instanceof e.wrappers.ShadowRoot || (r[n++] = i);
        return n
    }
    ...
    function i(e, t, n) {
        var r = e.localName;
        return r === t || r === n && e.namespaceURI === _
    }
    ...
    function l(e, t, n, r, o, i) {
        for (var a = e.firstElementChild; a;)r(a, o, i) && (n[t++] = a), t = l(a, t, n, r, o, i), a = a.nextElementSibling;
        return t
    }

    function p(n, r, o, i, a) {
        var s, c = g(this), u = m(this).root;
        if (u instanceof e.wrappers.ShadowRoot)return l(this, r, o, n, i, null);
        if (c instanceof L)s = S.call(c, i); else {
            if (!(c instanceof N))return l(this, r, o, n, i, null);
            s = E.call(c, i)
        }
        return t(s, r, o, a)
    }
    ...
    function d(n, r, o, i, a) {
        var s, c = g(this), u = m(this).root;
        if (u instanceof e.wrappers.ShadowRoot)return l(this, r, o, n, i, a);
        if (c instanceof L)s = T.call(c, i, a); else {
            if (!(c instanceof N))return l(this, r, o, n, i, a);
            s = M.call(c, i, a)
        }
        return t(s, r, o, !1)
    }
    ...
    var h = e.wrappers.HTMLCollection, w = e.wrappers.NodeList, m = e.getTreeScope, g = e.unsafeUnwrap, v = e.wrap, b = document.querySelector, y = document.documentElement.querySelector, E = document.querySelectorAll, S = document.documentElement.querySelectorAll, M = document.getElementsByTagName, T = document.documentElement.getElementsByTagName, O = document.getElementsByTagNameNS, j = document.documentElement.getElementsByTagNameNS, L = window.Element, N = window.HTMLDocument || window.Document, _ = "http://www.w3.org/1999/xhtml", C = {
        querySelector: function (t) {
            var o = n(t), i = o !== t;
            t = o;
            var a, s = g(this), c = m(this).root;
            if (c instanceof e.wrappers.ShadowRoot)return r(this, t);
            if (s instanceof L)a = v(y.call(s, t)); else {
                if (!(s instanceof N))return r(this, t);
                a = v(b.call(s, t))
            }
            return a && !i && (c = m(a).root) && c instanceof e.wrappers.ShadowRoot ? r(this, t) : a
        }, querySelectorAll: function (e) {
            var t = n(e), r = t !== e;
            e = t;
            var i = new w;
            return i.length = p.call(this, o, 0, i, e, r), i
        }
    }, D = {
        getElementsByTagName: function (e) {
            var t = new h, n = "*" === e ? a : i;
            return t.length = d.call(this, n, 0, t, e, e.toLowerCase()), t
        }, getElementsByClassName: function (e) {
            return this.querySelectorAll("." + e)
        }, getElementsByTagNameNS: function (e, t) {
            var n = new h, r = null;
            return r = "*" === e ? "*" === t ? a : s : "*" === t ? c : u, n.length = f.call(this, r, 0, n, e || null, t), n
        }
    };
    e.GetElementsByInterface = D, e.SelectorsInterface = C
}(window.ShadowDOMPolyfill), function (e) {
    "use strict";
    function t(e) {
    ...
    }), w.prototype.webkitCreateShadowRoot && (r.prototype.webkitCreateShadowRoot = r.prototype.createShadowRoot), p(r.prototype, o), p(r.prototype, i), p(r.prototype, c), p(r.prototype, u), d(w, r, document.createElementNS(null, "x")), e.invalidateRendererBasedOnAttribute = t, e.matchesNames = m, e.wrappers.Element = r
}(window.ShadowDOMPolyfill), function (e) {
    "use strict";
    function t(e) {
        switch (e) {
    ...
    function E(e) {
        return e instanceof j || e instanceof L
    }
    ...
    B.equals = function (e, t) {
        ...
        render: function (e) {
            ...
            if (!(e instanceof L))if (e instanceof j) {
                var n = e;
    ...
    }, j.prototype.getDistributedNodes = L.prototype.getDistributedNodes = function () {
        return s(), i(this)
    }, O.prototype.getDestinationInsertionPoints = function () {
        return s(), g(this) || []
    }, j.prototype.nodeIsInserted_ = L.prototype.nodeIsInserted_ = function () {
    ...
    function n(e) {
        ...
        t.prototype[e] = function () {
            return N(n.apply(j(this), arguments))
        }
    }

    function r(e, t) {
        D.call(j(t), L(e)), o(e, t)
    }
    ...
    b([window.HTMLBodyElement, window.HTMLDocument || window.Document, window.HTMLHeadElement, window.HTMLHtmlElement], ["appendChild", "compareDocumentPosition", "contains", "getElementsByClassName", "getElementsByTagName", "getElementsByTagNameNS", "insertBefore", "querySelector", "querySelectorAll", "removeChild", "replaceChild"].concat(y)), b([window.HTMLDocument || window.Document], ["adoptNode", "importNode", "contains", "createComment", "createDocumentFragment", "createElement", "createElementNS", "createEvent", "createEventNS", "createRange", "createTextNode", "elementFromPoint", "getElementById", "getElementsByName", "getSelection"]), E(t.prototype, u), E(t.prototype, p), E(t.prototype, f), E(t.prototype, {
        get implementation() {
            var e = C.get(this);
            return e ? e : (e = new a(L(this).implementation), C.set(this, e), e)
        }, get defaultView() {
